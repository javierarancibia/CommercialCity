...
ActiveRecord::Schema.define(version: 2020_11_16_173611) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["estate_id"], name: "index_likes_on_estate_id"
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.string "email"
    t.string "address"
    t.integer "secondary_number", default: 0
    t.string "facebook_profile", default: "@"
    t.string "twitter_profile", default: "@"
    t.string "instagram_profile", default: "@"
    t.string "job_position", default: "Sin especificar"
    t.string "zone", default: "Region Metropolitana"
