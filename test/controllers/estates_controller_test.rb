...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { address: @estate.address, bathrooms: @estate.bathrooms, name: @estate.name, price: @estate.price, rooms: @estate.rooms } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { address: @estate.address, bathrooms: @estate.bathrooms, name: @estate.name, price: @estate.price, rooms: @estate.rooms } }
